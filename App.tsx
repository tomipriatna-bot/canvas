...
const loadingMessages = [
    ...
    "Meninjau pemandangan...",
    "Menjelaskan lokasi penempatan dengan AI...",
    "Membuat prompt komposisi yang sempurna...",
    "Menghasilkan opsi fotorealistik...",
    "Merakit pemandangan akhir..."
];
...
const App: React.FC = () => {
  ...
  const handleProductImageUpload = useCallback((file: File) => {
    ...
    try {
      ...
      setError(`Tidak dapat memuat gambar produk. Detail: ${errorMessage}`);
      console.error(err);
    }
  }, []);
  ...
  const handleInstantStart = useCallback(async () => {
    ...
    try {
      ...
      if (!objectResponse.ok || !sceneResponse.ok) {
        throw new Error('Gagal memuat gambar default');
      }
      ...
      const errorMessage = err instanceof Error ? err.message : 'Terjadi kesalahan yang tidak diketahui.';
      setError(`Tidak dapat memuat gambar default. Detail: ${errorMessage}`);
      console.error(err);
    }
    ...
    if (error) {
       return (
           <div className="text-center animate-fade-in bg-red-50 border border-red-200 p-8 rounded-lg max-w-2xl mx-auto">
            <h2 className="text-3xl font-extrabold mb-4 text-red-800">Terjadi Kesalahan</h2>
        ...
        <div className="w-full max-w-6xl mx-auto animate-fade-in">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
            <div className="flex flex-col">
              <h2 className="text-2xl font-extrabold text-center mb-5 text-zinc-800">Unggah Produk</h2>
              <ImageUploader 
                id="product-uploader"
            ...
            <div className="flex flex-col">
              <h2 className="text-2xl font-extrabold text-center mb-5 text-zinc-800">Unggah Pemandangan</h2>
              <ImageUploader 
                id="scene-uploader"
          ...
          <div className="text-center mt-10 min-h-[4rem] flex flex-col justify-center items-center">
            <p className="text-zinc-500 animate-fade-in">
              Unggah gambar produk dan gambar pemandangan untuk memulai.
            </p>
      ...
      <div className="w-full max-w-7xl mx-auto animate-fade-in">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
          ...
          <div className="md:col-span-1 flex flex-col">
            <h2 className="text-2xl font-extrabold text-center mb-5 text-zinc-800">Produk</h2>
          ...
          <div className="md:col-span-2 flex flex-col">
            <h2 className="text-2xl font-extrabold text-center mb-5 text-zinc-800">Pemandangan</h2>
            <div className="flex-grow flex items-center justify-center">
              <ImageUploader 
                  ref={sceneImgRef}
                  id="scene-uploader" 
        ...
        <div className="text-center mt-10 min-h-[8rem] flex flex-col justify-center items-center">
           {isLoading ? (
             ...
             <p className="text-zinc-500 animate-fade-in">
                Seret produk ke lokasi di pemandangan, atau cukup klik di mana Anda menginginkannya.
             </p>
           )}
        </div>
      </div>
