    ...
    >
      ...
      >
        ...
        <div className="text-center mb-4 flex-shrink-0">
          <h2 className="text-2xl font-extrabold text-zinc-800">Tampilan Debug</h2>
        </div>
        
        <div className="flex flex-col gap-4 overflow-y-auto">
          <div>
            <p className="text-zinc-600 mb-2">Ini adalah gambar yang dikirim ke AI, dengan penanda merah yang menunjukkan penempatan.</p>
            <div className="rounded-lg overflow-hidden bg-zinc-100">
                <img src={imageUrl} alt="Tampilan debug dari pemandangan yang ditandai" className="w-full h-full object-contain" />
            </div>
          </div>
          
          {prompt && (
            <div>
                <h3 className="text-lg font-bold text-zinc-800 mb-2">Prompt Akhir untuk Model Gambar</h3>
